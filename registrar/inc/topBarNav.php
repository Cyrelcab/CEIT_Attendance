<!-- Navbar -->
      ...
      <div class="container">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="<?php echo base_url ?>/registrar" class="nav-link">Back</a>
          </li>
        </ul>
      </div>
        <!-- Right navbar links -->
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="javascript:void(0)" onclick="location.replace('<?php echo base_url.'/admin?f=rlogout' ?>')" role="button">
